...
class WC_Ginger_Mobilepay_Block extends WC_Ginger_Abstract_Block_Payment {
    ...
    protected function get_payment_method_label() {
        return __('MobilePay', WC_Ginger_BankConfig::BANK_PREFIX);
    }
}
